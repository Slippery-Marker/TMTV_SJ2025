...
public partial class PlayerMouseLook : Camera3D
{
    ...
    [Export] public float Sensitivity { get; set; } = 0.005f; // Reduced sensitivity for better feel
    [Export(PropertyHint.Range, "-1.57,0.0,0.01")] 
    public Vector2 VertRotLimit { get; set; } = new Vector2(-Mathf.Pi / 2, Mathf.Pi / 2); // Radians! -90 to 90
